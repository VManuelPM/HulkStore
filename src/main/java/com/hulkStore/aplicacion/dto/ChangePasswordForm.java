package com.hulkStore.aplicacion.dto;
...
public class ChangePasswordForm {
	...
	@NotNull
	private Long id;
	@NotBlank(message="El password actual no puede estar vacio")
	private String currentPassword;

	@NotBlank(message="El password nuevo no puede estar vacio")
	private String newPassword;

	@NotBlank(message="Confirmar Password no puede estar vacio")
